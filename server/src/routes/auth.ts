...
import { authenticate, createSession, destroySession, SESSION_COOKIE } from "../auth";
...
// Registration is intentionally closed: the single admin is seeded from env
// (see seedAdmin). Only login/logout/me are exposed.
